...
shift
set subj=($argv)
mkdir -p $dataPath/TBSS
mkdir -p $dataPath/TBSS/data
mkdir -p  $dataPath/TBSS/TP1
mkdir -p $dataPath/TBSS/TP2
...
foreach s ($subj)
	...
	bash ${halfregPath}/halfreg.sh $dataPath/TBSS/data/${s}_FA_TP1.nii.gz $dataPath/TBSS/data/${s}_FA_TP2.nii.gz $dataPath/TBSS/data/${s}_FA_TP1_halfway.nii.gz $dataPath/TBSS/data/${s}_FA_TP2_halfway.nii.gz
